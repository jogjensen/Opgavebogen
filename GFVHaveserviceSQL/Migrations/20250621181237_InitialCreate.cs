    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignedWorkersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TasksId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskWorkers", x => new { x.AssignedWorkersId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_TaskWorkers_AspNetUsers_AssignedWorkersId",
                        column: x => x.AssignedWorkersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskWorkers_WorkTasks_TasksId",
                        column: x => x.TasksId,
